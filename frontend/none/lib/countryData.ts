export interface CountryConfig {
  ...
  format?: string; // Phone number format hint
}
...
export const COUNTRIES: CountryConfig[] = [
  ...
  { name: "Vatican", code: "VA", dialCode: "+39-06", flag: "🇻🇦" },
