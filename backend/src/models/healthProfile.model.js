...
const HealthProfileModel = {
  ...
  createPayload(userId, input, existingData = null) {
    return removeUndefinedValues({
      ...
      targetCarbs: input.targetCarbs ?? existingData?.targetCarbs ?? null,
      targetProtein: input.targetProtein ?? existingData?.targetProtein ?? null,
      targetFat: input.targetFat ?? existingData?.targetFat ?? null,
